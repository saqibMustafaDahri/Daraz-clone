...
function Foryou() {
  ...
  return (
    <BoxAtom>
      <BoxAtom sx={{p: 2,borderTop: "2px solid #eee",borderBottom: "2px solid #eee",marginTop: 5,width: 1300,}}>
        <TypographyAtom sx={{ fontSize: 25, fontWeight: 700 }}text="Just For You"/>
